...
const Footer = () => {
  return (
    <footer className="w-full bg-[#fae9e6] text-[#ff006c] py-8 absolute bottom-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex justify-center items-center">
        <div className="flex flex-col justify-center gap-5 w-full lg:w-[60%] md:w-[70%] sm:w-[90%]">
          ...
          <div className="flex space-x-4 justify-center items-center">
            <a href="https://www.facebook.com/mayakkatheriya/" target="_blank" rel="noopener noreferrer" className="text-[#ff006c] hover:text-[#e67e22] transition-colors duration-200">
              <i className="fab fa-facebook-f"></i>
            </a>
            <a href="https://www.instagram.com/gupta_ji_813/" target="_blank" rel="noopener noreferrer" className="text-[#ff006c] hover:text-[#e67e22] transition-colors duration-200">
              <i className="fab fa-instagram"></i>
            </a>
            <a href="https://github.com/Mayankkatheriya" target="_blank" rel="noopener noreferrer" className="text-[#ff006c] hover:text-[#e67e22] transition-colors duration-200">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/mayank-gupta-752328173/" target="_blank" rel="noopener noreferrer" className="text-[#ff006c] hover:text-[#e67e22] transition-colors duration-200">
